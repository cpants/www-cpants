package WWW::CPANTS::API::Model::Acme::CPANAuthors::Stats::Releases;
...
sub path_template ($self) { '/cpan_authors/{module_id}/stats/releases' }
...
sub _load ($self, $params = []) {
    ...
    my $rows        = $stats_table->select_releases_by_module_id($params->{module_id});
