package WWW::CPANTS::API::Model::Acme::CPANAuthors::Stats::NewAuthors;
...
sub path_template ($self) { '/cpan_authors/{module_id}/stats/new_authors' }
...
sub _load ($self, $params = []) {
    ...
    my $rows        = $stats_table->select_new_authors_by_module_id($params->{module_id});
