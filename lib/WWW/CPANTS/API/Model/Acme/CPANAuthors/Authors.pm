                                ...
                                data         => {
                                    ...
                                    items => {
                                        ...
                                        properties => {
                                            ...
                                            last_release          => { type => 'string', format => 'date', nullable => 1 },
                                            last_new_release      => { type => 'string', format => 'date', nullable => 1 },
                                            average_kwalitee      => { type => 'number', format => 'float', nullable => 1 },
                                            average_core_kwalitee => { type => 'number', format => 'float', nullable => 1 },
                                            registered            => { type => 'string', format => 'date', nullable => 1 },
                                        },
                                    },
                                },
                                module => {
